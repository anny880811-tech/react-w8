                    ...
                    {products.map((product) => {
                        return (<SwiperSlide key={product.id} >
                            <div className="course-card shadow-sm mx-auto">
                                <img src={product.imageUrl} className="course-img" alt={product.title} />
                                <div className="card-body">
                                    <h5 className="text-truncate">{product.title}</h5>
                                    <p className="course-content small text-muted">{product.content}</p>
                                    <button className="btn btn-brown btn-sm" onClick={() => navigate(`/product/${product.id}`)}>了解課程</button>
                                </div>
                            </div>
                        </SwiperSlide>)
                    })}
