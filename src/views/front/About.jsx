...
const rightImg = ['pexels-photo-18499500.png', '03.png', '06.png'];
const leftImg = ['classroom.png', '02.png', '05.jpeg']
                    ...
                    {rightImg.map((item, index) => {
                        return <SwiperSlide><div className="responsive-container">
                            ...
                            <div className="panel panel-right">
                                <img src={`/src/assets/${item}`} alt="教室長圖" /> 
                            </div>
                            {/* 左圖作為「覆蓋層」，它蓋在右圖上面，並切出斜邊 */}
                            <div className="panel panel-left">
                                <img src={`/src/assets/${leftImg[index]}`} alt="教室方圖" />
                            </div>
                        </div>
                        </SwiperSlide>
                    })}
