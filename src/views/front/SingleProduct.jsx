...
const SingleProduct = () => {
  ...
  const getRelatedProducts = async (category) => {
    try {
      ...
      const requests = targetCategories.map((cat) => {
        return axios.get(
          `${API_BASE}/api/${API_PATH}/products?category=${cat}`,
        )
      })
          ...
          <div className="row gx-lg-5 gy-4 align-items-stretch mt-2">
            ...
            <div className="col-lg-8">
              <div
                ...
                style={{ backgroundColor: 'rgb(253, 247, 245)' }}
              >
                <h3 className="card-title mt-3 mb-3">{product.title}</h3>
                <button type="button" className="btn btn-deepPink mb-4">
                  {product.category}
                </button>
                ...
                <div className="mb-3">
                  ...
                  <div className="d-flex align-items-center">
                    ...
                    <span
                      className="ms-2 fs-5 mb-0"
                      style={{ color: 'rgb(109, 77, 67)' }}
                    >
                      {product.unit}
                    </span>
                  </div>
