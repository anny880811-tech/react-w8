        ...
        <div className="container pt-0 pt-md-5">
            <div className="row">
                <div className="col-12 col-md-6 text-center text-md-start ps-md-5">
                    <img src={notFound} alt="404" className="img-fluid" style={{ height: '500px', objectFit: 'contain' }} />
                </div>
                <div className="col-12 col-md-6 ms-5 ms-md-0 pt-0 pt-md-5 mt-md-5">
                    <div className="display-1 fw-bold mt-md-2" style={{ color: 'rgb(109, 77, 67)', textShadow: '2px 2px 4px rgba(0, 0, 0, 0.5)' }}>404</div>
