        ...
        <nav className="custom-navbar">
          ...
          <div className="nav-login-group">
            <NavLink className="nav-link-item position-relative fs-3" to="/cart">
              ...
              <span
                className="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-danger fs-8"
                style={{ fontSize: '0.8rem', padding: '0.25rem 0.35rem' }}
              >
                {carts.length}
              </span>
            </NavLink>
              ...
              <div className="footer-social-group text-start">
                ...
                <div className="text-start text-white contact-info mt-2">
                  <h6 className="text-white">
                    ...
                    <a href="tel:04-75262658" className="tel-custom"> 04-75262658</a>
                  </h6>
                  <h6 className="text-white">
                    場館地址：臺中市西屯區國安一路1688號
                  </h6>
                </div>
              </div>
            </div>
